...
Identify rare species that have an average (across all time points) relative abundance below 1% in a community.
Theses rare species are selected and the fraction of microcosm in which they were is given. A value of 1 indicates they were rare (<1%) in all of 18 microcosms. 
...
We determine the fraction of microcosms with and without predators in which species are common.
If the resulting value is NA for a predator condition the species is rare in all microcosm of this predator condition.
...
How frequent are those species for which we found variants in the meta-genomic data?
...
These are the species found above (minus HAMBI-2160, which is only common in one microcosm).
