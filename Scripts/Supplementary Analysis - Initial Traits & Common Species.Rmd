...
2) Conversely we identify species that are common (>1%).
...
3) Are there species common depending on predator presence? 
...
4) How frequent are those five species for which we found parallel mutations during the experiment?
