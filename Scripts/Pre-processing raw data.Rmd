...
---
## Aim
With this script I pre-process the phenotypic data acquired from clones during the community (mis-)match experiment.
I also merge the counts data from 16s rRNA sequecning with the corresponding metadata.
